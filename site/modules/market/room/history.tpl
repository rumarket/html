            ...
            <div class="l-cabinet__inn">
              <div class="l-cabinet__aside">
                <div class="border-block">
                  ...
                  <ul class="categories-menu">
                    ...
                    <li class="categories-menu__item">
                      <div class="categories-menu__item-inn">
                        <a href="cabinet-history.html" class="categories-menu__link is-active">История покупок</a>
                      </div>
                    </li>
                    <li class="categories-menu__item">
                      <div class="categories-menu__item-inn">
              ...
              <div class="l-cabinet__main">
                <div class="title h1">
                  ...
                  <div class="cabinet-menu">
                    ...
                    <ul class="cabinet-menu__list js-cabinet-menu">
                      ...
                      <li class="cabinet-menu__item">
                        <a href="cabinet-history.html" class="cabinet-menu__link is-active">История покупок</a>
                      </li>
                      <li class="cabinet-menu__item">
                ...
                <div class="p-history">
                            ...
                            <ul class="sort__list">
                              <li>
                                <label class="sort__item js-sort-item is-active">
                                  ...
                                  <span> Все заказы</span></label>
                              </li>
                              <li>
                                <label class="sort__item js-sort-item">
                                  <input type="radio" name="sort">
                                  <span>Завершенные</span></label>
                              </li>
                              <li>
                                <label class="sort__item js-sort-item">
                                  <input type="radio" name="sort">
                                  <span>Отмененные</span></label>
                              </li>
                              <li>
                                <label class="sort__item js-sort-item">
                                  <input type="radio" name="sort">
                                  <span>В ожидании</span></label>
                              </li>
                            </ul>
                          </div>
                        </div>
                  ...
                  <div class="p-history__main">
                    <div class="p-history__table">
                      <div class="table">
                        <table>
                          <thead>
                            <tr>
                              ...
                              <th>Дата создания</th>
                              <th>Сумма</th>
                              <th class="hidden-sm">Отзыв менеджеру</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr>
                              ...
                              <div class="status-row">
                                <div class="status-row__inn">
                                  <div class="status-row__icon">
                                    <div class="status-icon status-icon--wait"></div>
                                  </div>
                                  <div class="status-row__info">
                                    <div>
                                      <a href="#" class="link link--ul">242342234</a>
                                    </div>
                                    <div>
                                      Статус: в процессе
                                    </div>
                            ...
                            <tr>
                              ...
                              <div class="status-row">
                                <div class="status-row__inn">
                                  <div class="status-row__icon">
                                    <div class="status-icon status-icon--accept"></div>
                                  </div>
                                  <div class="status-row__info">
                                    <div>
                                      <a href="#" class="link link--ul">242342234</a>
                            ...
                            <tr>
                              ...
                              <td>03.09.2017</td>
                              <td>15 600 р.</td>
                              <td class="hidden-sm"><div class="long-dash"></div></td>
                            </tr>
                            <tr>
                              <td>
                              <div class="status-row">
                      ...
                      <div class="p-history__table-more">
                        <a href="#" class="more-btn">Показать еще</a>
                      </div>
                    </div>
                    <div class="p-history__years">
                      <div class="border-block">
                        <div class="p-history__years-inn">
                          <div class="p-history__years-item">
                            <a href="#" class="link">2017 (12)</a>
                          </div>
                          <div class="p-history__years-item">
                            <a href="#" class="link">2016 (12)</a>
                          </div>
                          <div class="p-history__years-item">
                            <a href="#" class="link">2015 (23)</a>
                          </div>
                          <div class="p-history__years-item">
                            <a href="#" class="link">2014 (7)</a>
                          </div>
                          <div class="p-history__years-item">
                            <a href="#" class="link">2013 (6)</a>
                          </div>
                        </div>
                      </div>
                    </div>
