					...
					<div class="l-cabinet">
						<div class="l-cabinet__inn">
							<div class="l-cabinet__aside">
								<div class="border-block">
									...
									<ul class="categories-menu">
										...
										<li class="categories-menu__item">
											<div class="categories-menu__item-inn">
												<a href="cabinet-bonus.html" class="categories-menu__link is-active">Мои бонусы</a>
											</div>
										</li>
										<li class="categories-menu__item">
											<div class="categories-menu__item-inn">
							...
							<div class="l-cabinet__main">
								<div class="title h1">
									...
									<div class="cabinet-menu">
										...
										<ul class="cabinet-menu__list js-cabinet-menu">
											...
											<li class="cabinet-menu__item">
												<a href="cabinet-bonus.html" class="cabinet-menu__link is-active">Мои бонусы</a>
											</li>
											<li class="cabinet-menu__item">
								...
								<div class="p-bonus">
									<div class="group-box">
										<div class="bg-block p-bonus__score">
											<div class="bg-block__group">
												<div class="bonus-box bonus-box--lg">
													<div class="bonus-box__text">
														У вас на счету <span>3457</span> бонусных рублей
													</div>
													<div class="bonus-box__hint">
														Бонусными рублями можно оплатить до 40% стоимости заказа
													</div>
												</div>
											</div>
										</div>
										...
										<div class="hints">
												...
												<div class="hint">
													<div class="hint__inn">
														<div class="hint__icon">
															<i class="ticon ticon-cart-1 "></i>
														</div>
														<div class="hint__main">
															<div class="hint__title">
																За покупку товара <a href="#" class="hint__info"></a>
															</div>
											...
											<div class="hints__item">
												<div class="hint">
													<div class="hint__inn">
														<div class="hint__icon">
															<i class="ticon ticon-form "></i>
														</div>
														<div class="hint__main">
															<div class="hint__title">
																За заполнение анкеты <a href="#" class="hint__info"></a>
															</div>
															<div class="hint__label">
																250 бонусных рублей
															</div>
											...
											<div class="hints__item">
												<div class="hint">
													<div class="hint__inn">
														<div class="hint__icon">
															<i class="ticon ticon-dialog "></i>
														</div>
														<div class="hint__main">
															<div class="hint__title">
																За рекомендацию <a href="#" class="hint__info"></a>
															</div>
															<div class="hint__label">
											...
											<div class="hints__item">
												<div class="hint">
													<div class="hint__inn">
														<div class="hint__icon">
															<i class="ticon ticon-share-1 "></i>
														</div>
														<div class="hint__main">
															<div class="hint__title">
																Репост в соцсетях <a href="#" class="hint__info"></a>
															</div>
															<div class="hint__label">
																100 бонусных рублей
															</div>
											...
											<div style="width: 66.66%;" class="hints__item">
												<div class="hint">
													<div class="hint__inn">
														<div class="hint__icon">
															<i class="ticon ticon-camera "></i>
														</div>
														<div class="hint__main">
															<div class="hint__title">
																Загрузите фото купленных товаров <a href="#" class="hint__info"></a>
															</div>
															<div class="hint__label">
																150 бонусных рублей за каждое фото товара
															</div>
														</div>
													</div>
												</div>
									...
									<div class="subtitle">
										История начислений и списания бонусов
									</div>
									<div class="p-bonus__table">
										<div class="table">
											<table>
												<thead>
													<tr>
														<th>Действия</th>
														<th>Дата создания</th>
														<th>Бонусные рубли</th>
													</tr>
												</thead>
												<tbody>
													<tr>
														<td>Номер заказа: <a href="#" class="link link--ul">242342234</a></td>
														<td>09.09.2017</td>
														<td><span class="text-style2">+280</span></td>
													</tr>
													<tr>
														<td>Заполнение анкеты</td>
														<td>06.09.2017</td>
														<td><span class="text-style2">+390</span></td>
													</tr>
													<tr>
														<td>Номер заказа: <a href="#" class="link link--ul">97867867</a></td>
														<td>01.09.2017</td>
														<td><span class="text-dark-green">-890</span></td>
													</tr>
												</tbody>
											</table>
										</div>
