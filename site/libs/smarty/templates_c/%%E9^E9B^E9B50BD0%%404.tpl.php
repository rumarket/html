<?php /* Smarty version 2.6.11, created on 2021-04-04 20:07:23
					...
					<div class="p-404">
						...
						<div class="p-404__buttons">
							<div class="p-404__buttons-title">
								Получите скидку <span>10%</span> на все товары
							</div>
							<div class="row">
								<div class="col-sm-6">
									<a href="#" class="btn btn--vinous btn--lg">Получить промокод на email</a>
								</div>
								<div class="col-sm-6">
									<a href="#" class="btn btn--pink btn--lg">Получить промокод по SMS</a>
								</div>
							</div>
						</div>
					</div>
...
js/libs.js"></script>
		<script type="text/javascript" src="/assets/
js/lightGallery/js/lightgallery.min.js"></script>
